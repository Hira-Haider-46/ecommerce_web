...
const Collection: React.FC = () => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row gap-1 md:gap-10 pt-10 ${
        !showSearch && `border-t`
      } border-gray-400`}
    >
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-6">
          ...
          <select
            ...
            className="border-2 border-gray-300 text-sm px-2 cursor-pointer outline-none bg-white"
          >
        ...
        >
          {filterProducts.length > 0 ? (
            ...
            <p className="text-gray-600 mt-20 text-lg text-center mx-auto">
              No Products to show
            </p>
          )}
        </div>
